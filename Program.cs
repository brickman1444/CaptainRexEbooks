    ...
    static class Program
    {
        ...
        public static string[] GetQuotes()
        {
            return new string[] {
                ...
                "I'm part of the most pivotal moment in the history of the Republic. If we fall then our children and their children could be forced to live under an evil I can't well",
                "imagine.",
